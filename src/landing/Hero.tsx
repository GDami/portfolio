    ...
    return (
        <div className="hero" id="home">
            ...
            <div className='hero-heading'>
                ...
                <h3 className='hero-subtext'>I am a <span>junior frontend developer</span> passionate about creating user-focused experiences, with special attention to detail.</h3>
