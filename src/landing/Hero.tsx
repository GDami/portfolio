    ...
    return (
        <div className="hero" id="home">
            ...
            <div className='hero-heading'>
                ...
                <h3 className='hero-subtext'>I'm a junior <strong>frontend developer</strong> who creates user-focused experiences, and gives special attention to <span className='animated-underline'>detail</span>.</h3>
