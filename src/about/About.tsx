...
export function About() {
    ...
    return (
        <div className='section-container about' id="about">
            <h1 className='main-heading section-title animated-underline'>About <span>me</span></h1>
